...
const FinancialAdvisory: React.FC = () => {
  return (
    <div className="pt-20">
      {/* Header */}
      <section className="section-padding bg-bg-secondary text-white relative overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <h1 className="mb-8">Practical <span className="gradient-text italic">Financial Advice</span> for Everyday Decisions</h1>
      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center">
            <a 
              href="mailto:max0matrixx@gmail.com?subject=Financial Service Inquiry - MaxMatrix&body=Hello MaxMatrix Team,%0D%0AI would like guidance regarding financial services.%0D%0APlease contact me."
      ...
      <section className="section-padding bg-bg-secondary border-y border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="bg-bg-card border border-white/10 p-8 sm:p-12 rounded-3xl text-white relative overflow-hidden max-w-4xl mx-auto text-center">
      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="mb-6">Our <span className="gradient-text">Financial Philosophy</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card text-center">
              <div className="w-12 h-12 bg-white/5 text-brand-teal rounded-full flex items-center justify-center mx-auto mb-6 border border-white/10">
                <TrendingUp size={24} />
              </div>
            ...
            <div className="card text-center">
              <div className="w-12 h-12 bg-white/5 text-brand-purple rounded-full flex items-center justify-center mx-auto mb-6 border border-white/10">
                <PieChart size={24} />
              </div>
