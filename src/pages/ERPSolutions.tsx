...
const ERPSolutions: React.FC = () => {
  return (
    <div className="pt-20">
      {/* Header */}
      <section className="section-padding bg-bg-secondary text-white overflow-hidden relative border-b border-white/5">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <h1 className="mb-8">ERP Solutions for <span className="gradient-text italic">Growing Businesses</span></h1>
      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center">
            <a 
              href="mailto:max0matrixx@gmail.com?subject=IT Service Inquiry - MaxMatrix&body=Hello MaxMatrix Team,%0D%0AI would like to discuss IT services regarding my business.%0D%0APlease contact me."
      ...
      <section className="section-padding bg-bg-secondary border-y border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto text-center mb-12 sm:mb-16">
            <h2 className="mb-6">Who This Is <span className="gradient-text">For</span></h2>
